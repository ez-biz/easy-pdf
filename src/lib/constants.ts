...
export const TOOLS: Tool[] = [
    ...
    },
    {
        id: "pdf-to-zip",
        name: "PDF to ZIP",
        description: "Package PDFs into a ZIP archive for sharing",
        href: "/pdf-to-zip",
        icon: "Archive",
        category: "organize",
    ...
    },
    {
        id: "create-pdf",
        name: "Create PDF",
        description: "Create a new blank PDF with custom page size",
        href: "/create-pdf",
        icon: "FilePlus",
        category: "convert",
    ...
    },
    {
        id: "extract-text",
        name: "Extract Text",
        description: "Extract plain text from any PDF document",
        href: "/extract-text",
        icon: "FileText",
        category: "convert",
    ...
    },
    {
        ...
        description: "Convert Markdown to a formatted PDF document",
    ...
    },
    {
        id: "csv-to-pdf",
        name: "CSV to PDF",
        description: "Convert CSV spreadsheet data to a PDF table",
        href: "/csv-to-pdf",
        icon: "Table",
        category: "convert",
    ...
    },
    {
        id: "flatten-pdf",
        name: "Flatten PDF",
        description: "Merge form fields and annotations permanently",
        href: "/flatten-pdf",
        icon: "Layers",
        category: "edit",
    ...
    },
    {
        id: "fill-pdf-form",
        name: "Fill PDF Form",
        description: "Fill interactive form fields in your PDF documents",
        href: "/fill-pdf-form",
        icon: "FormInput",
        category: "edit",
